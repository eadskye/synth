...
/***/ function(module, exports, __webpack_require__) {
	...
	var SynthApp = __webpack_require__(168);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var OscArray = __webpack_require__(169);
	var Oscillator = __webpack_require__(178);
	var FilterStage = __webpack_require__(179);

	var SynthApp = React.createClass({
	  ...
	  summedSignal: function summedSignal() {
	    return this.state.oscillators.map(function (osc) {
	      return osc.osc.getOscNode();
	    });
	  },

	  onAdd: function onAdd(e) {
	    var nextItems = this.state.oscillators.concat({
	      id: Date.now(),
	      osc: new Oscillator()
	    });
	  ...
	  onDestroy: function onDestroy(id) {
	    var nextItems = this.state.oscillators;
	    var i = this.state.oscillators.findIndex(function (osc) {
	      return osc.id === id;
	    });
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(OscArray, {
	        onAdd: this.onAdd,
	        oscillators: this.state.oscillators,
	        destroy: this.onDestroy,
	        summedSignal: this.summedSignal() }),
	      React.createElement(FilterStage, { signal: this.summedSignal() })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Oscillator = __webpack_require__(170);
	var Scope = __webpack_require__(175);

	var OscillatorArray = function OscillatorArray(props) {
	  return React.createElement(
	    'div',
	    ...
	    React.createElement(
	      'div',
	      { className: 'osc-array' },
	      props.oscillators.map(function (osc) {
	        return React.createElement(Oscillator, {
	          id: osc.id,
	          key: osc.id,
	          osc: osc.osc,
	    ...
	    React.createElement(Scope, { signal: props.summedSignal })
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var GainButton = __webpack_require__(171);
	var FreqSlider = __webpack_require__(172);
	var TypeToggle = __webpack_require__(173);
	var DestroyButton = __webpack_require__(174);
	var Scope = __webpack_require__(175);

	/* 
	 * @props {AudioNode} osc
	*/
	var OscillatorComponent = React.createClass({
	  ...
	  handleGainClick: function handleGainClick(e) {
	    e.preventDefault();
	  ...
	  handleTypeToggle: function handleTypeToggle(e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GainButton = function GainButton(props) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FreqSlider = function FreqSlider(props) {
	  return React.createElement(
	    "div",
	    null,
	    React.createElement(
	    ...
	    React.createElement("input", { type: "range", min: 0, max: 2000, onChange: props.handleSlide })
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TypeToggle = function TypeToggle(props) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var audioCtx = __webpack_require__(176);
	var connectSignal = __webpack_require__(177);

	var buildScope = function buildScope(canvas, signal) {
...
/***/ function(module, exports) {
	 ...
	 */
	var connectSignal = function connectSignal(signal, output) {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var FilterStage = function FilterStage(props) {
	  var routing = "serial";
	  var mix = 0.0;

	  return React.createElement(Filter, { signal: props.signal });
	};
	...
	var FilterComponent = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      null,
	      'Filter Cutoff:',
	      React.createElement(FreqSlider, { frequency: this.state.cutoff, handleSlide: this.handleSlide })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Filter() {
	  ...
	  this.connect = function (signal) {
	    connectSignal(signal, filterNode);
	  };
	}
